...
#define MAX_READ(i) (BW_REG_BASE + (2+i)*0x4)
#define MAX_WRITE(i) (BW_REG_BASE + (2+N+i)*0x4)
#define ENABLE_MASTERS (BW_REG_BASE + (2+2*N)*0x4)
#define DOMAIN_ID(i) (BW_REG_BASE + (3+2*N+i)*0x4)
...
int main(void)
{
  ...
  reg_write32(MAX_READ(0), 2);
  reg_write32(MAX_WRITE(0), 1);
